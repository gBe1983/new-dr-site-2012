...
function controlloSceltaEsperienze(){
	...
	if(scelta == ""){
		...
		if(contatoreSelezioneExp > 0){
			...
			window.location.href = "./index.jsp?azione=creaCv&sezione=esperienza&parametroId="+parametroId+"&dispositiva=dettaglioCurriculum";
			return false;
		}
...
function controlloSceltaDettaglio(){
	...
	if(scelta == ""){
		...
		window.location.href = "./index.jsp?azione=creaCv&sezione=dettaglio&parametroId="+parametro+"&dispositiva=dettaglioCurriculum";
		return false;
