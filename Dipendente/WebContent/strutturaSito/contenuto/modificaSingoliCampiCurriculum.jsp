...
<div class="creaCurriculum">
	...
	%>
					<div id="bluemenu" class="bluetabs">
						<ul>
							<li><a href="index.jsp?azione=dettaglioSingoliCampiCurriculum&tipoModifica=esperienze&idEsperienze=<%=esperienze.getIdEsperienze() %>&risorsa=<%=esperienze.getId_risorsa() %>&dispositiva=modificaSingoliCampiCurriculum">Dettaglio Esperienza</a></li>
