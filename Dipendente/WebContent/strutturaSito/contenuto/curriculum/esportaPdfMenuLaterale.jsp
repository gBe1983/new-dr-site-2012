...
<form action="./GestioneCurriculum" method="post" name="pdfMenuLatelare">
	...
	<input type="submit" value="esporta" onclick="return closeWindowsPdf()">
	<button value="chiudi" onclick="return closeFinestraPdf()">chiudi</button>
</form>