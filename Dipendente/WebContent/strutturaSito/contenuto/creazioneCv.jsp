...
<div class="creaCurriculum">
	...
	%>
			...
			%>
				<form action="./GestioneCurriculum" method="post" name="esperienze" class="spazio">
	...
	<%
				...
				%>
							<p align="center" class="spazio">Inserimento Dettaglio avvenuta con successo<br>
								<a href="index.jsp?azione=creazioneCv&tipoCreazione=esperienze&dettaglio=<%=request.getParameter("dettaglio") %>&dispositiva=cv" >Torna al Menu </a>							
							</p>
				<%
						}
					}
